<section>
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p>Menampilkan semua data kelurahan.</p>
            ...
            <form action="<?= base_url('admin/Kelembagaan/baru') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">kelurahan baru</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="hidden" class="form-control form-control-sm" name="kategori" value="kelurahan" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="kelurahan">Gambar</label>
                        ...
                        <div class="form-group mb-3">
                            <label for="kelurahan">Telp</label>
