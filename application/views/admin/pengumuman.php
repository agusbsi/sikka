    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header" style="display:flex; justify-content:flex-end">
                <a href="<?= base_url('admin/pengumuman/tambah_baru') ?>" class="btn btn-success btn-sm"><i class="bi bi-plus me-1"></i> Baru</a>
            </div>
            <div class="card-body">
                <p>Menampilkan semua data pengumuman.</p>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                        ...
                                        <div class="col-md-3">
                                            <img
                                                src="<?= $f->jenis == "Foto" && !empty($f->file)
                                                            ? base_url('assets/img/pengumuman/') . $f->file . '?timestamp=' . time()
                                ...
                                <td>
                                    <a href="<?= base_url('admin/pengumuman/detail/' . $f->id) ?>" class="btn btn-sm btn-primary" title="detail"><i class="bi bi-eye-fill"></i></a>
        ...
        $('.btn-hapus').click(function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    location.href = "<?= base_url('admin/Pengumuman/hapus/') ?>" + id;
                }
            })
        });
    });
