                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row position-relative">
                                        <?php if ($f->jenis == "Foto") { ?>
                                            <img src="<?= base_url('assets/img/event/') . $f->konten ?>?timestamp=<?= time(); ?>" alt="<?= $f->nama ?>" class="rounded" style="width:260px;">
                                        <?php } else { ?>
                                            <div class="video-container" style="position: relative; width: 260px; max-height: 200px;">
                                                <video class="video-element" style="width: 100%; max-height: 200px;" muted>
                                                    <source src="<?= base_url('assets/img/event/') . $f->konten ?>?timestamp=<?= time(); ?>" type="video/mp4">
                                                </video>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" id="namaEdit" name="event" placeholder="......" required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="event">Foto</label>
