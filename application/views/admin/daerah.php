<section>
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p>Menampilkan semua data Sekretariat Daerah.</p>
