<div class="container pt-100 pb-100">
    <div class="card">
        ...
        <div class="card-body">
            Semua dokumen Dokumen Publik tersedia disini, silahkan cari sesuai kebutuhan anda.
            <br>
                ...
                <tbody>
                    ...
                    foreach ($dokumen as $p):
                        ...
                        <tr>
                            ...
                            <td><?= $p->kategori ?></td>
                            <td><a href="<?= base_url('Utama/dokumen_detail/' . $p->id) ?>" class="btn btn-sm btn-primary">Detail</a></td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
            </table>
